...
pub fn do_trait_obj(count: i32) -> anyhow::Result<((&'static str, i32), (&'static str, i32), (&'static str, i32), (&'static str, i32), (&'static str, i32))> {
    ...
    let d: Box<dyn trait_obj::Animal> = Box::new(trait_obj::Crow::new(count, count + 1, count + 2, count + 3));
    let e: Box<dyn trait_obj::Animal> = Box::new(trait_obj::Frog::new(count, count + 1, count + 2, count + 3, count + 4));
    Ok(((a.talk(), a.sum()), (b.talk(), b.sum()), (c.talk(), c.sum()), (d.talk(), d.sum()), (e.talk(), e.sum())))
}

pub fn do_enum_obj(count: i32) -> anyhow::Result<((&'static str, i32), (&'static str, i32), (&'static str, i32), (&'static str, i32), (&'static str, i32))> {
    ...
    let d: Box<enum_obj::Animal> = Box::new(enum_obj::Animal::Crow(count, count + 1, count + 2, count + 3));
    let e: Box<enum_obj::Animal> = Box::new(enum_obj::Animal::Frog(count, count + 1, count + 2, count + 3, count + 4));
    Ok(((a.talk(), a.sum()), (b.talk(), b.sum()), (c.talk(), c.sum()), (d.talk(), d.sum()), (e.talk(), e.sum())))
}
